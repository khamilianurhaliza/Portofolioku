<footer class="bg-dark border-t border-white/10 relative overflow-hidden">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex space-x-6">
                ...
                <a href="<?= htmlspecialchars($settings['github_url']) ?>" target="_blank" class="text-gray-400 hover:text-white transition-colors">
                ...
                <a href="<?= htmlspecialchars($settings['linkedin_url']) ?>" target="_blank" class="text-gray-400 hover:text-white transition-colors">
                ...
                <a href="<?= htmlspecialchars($settings['instagram_url']) ?>" target="_blank" class="text-gray-400 hover:text-white transition-colors">
        ...
        <div class="mt-8 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
            <p class="text-base text-gray-500">
                &copy; <?= date('Y') ?> <?= htmlspecialchars($settings['author_name'] ?? 'Portofolioku') ?>. All rights reserved.
            </p>
            <p class="text-sm text-gray-600 mt-2 md:mt-0">
                Designed with <span class="text-secondary">&hearts;</span> and GSAP
            </p>
        </div>
    </div>
</footer>
